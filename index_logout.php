...
$data = mysqli_query($connection, "SELECT username FROM user WHERE username = '$temp'");
        ...
        <div class="container d-flex align-items-center justify-content-lg-between">
            ...
            <nav id="navbar" class="navbar order-last order-lg-0">
                <ul>
                    ...
                    <li class="dropdown"><a href="#"><span>Else</span> <i class="bi bi-chevron-down"></i></a>
                        <ul>
                            <li><a href="logout.php">Logout</a></li>
                            <li><a href="produk/pekerja.php?username=<?php echo $d['username'];?>">Worker's Data</a>
                            </li>
                            <li><a href="produk/jabatan.php?username=<?php echo $d['username'];?>">Position's
                                    Data</a>
                            </li>
        ...
        <div class="container" data-aos="fade-up">
            ...
            <div class="row justify-content-center" data-aos="fade-up" data-aos-delay="150">
                <div class="col-xl-6 col-lg-8">
                    <h1>Powerful Digital Solutions With Pertamina<span>.</span></h1>
