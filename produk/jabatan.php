...
<head>
    ...
    <title>Position's Data | Pertamina</title>
    ...
    <main id="main" class="">
        ...
        <div class="container mt-5">
            ...
            <div class="row justify-content-evenly fs-5 text-center align-items-center">
                <div class="col-md-12">
                    <a href="jabatan_tambah.php" class="tombol">Tambah</a>
                    <table class="table table-striped">
                        ...
                        <tbody>
                            <?php
                        include "../koneksi.php";
                        $query = mysqli_query($connection, "SELECT * FROM jabatan ORDER BY nama_jabatan ASC");
                        $no = 0;
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <a class="tombol_edit"
                                        href="jabatan_edit.php?id=<?php echo $data['id_jabatan'];?>">Edit</a>
                                    <a class="tombol_hapus"
                                        href="jabatan_hapus.php?id=<?php echo $data['id_jabatan'];?>">Hapus</a>
                                </td>
                            </tr>
                            <?php } ?>
                        </tbody>
